...
class Wuhbuliding(BaseDataset):
    def __init__(self, 
        ...
        super(Wuhbuliding, self).__init__(ignore_label, base_size,
    ...
    def __getitem__(self, index):
        ...
        image = cv2.imread(os.path.join(self.root,'wuhbuliding',item["img"]),
                           cv2.IMREAD_COLOR)
        size = image.shape
        ...
        label = cv2.imread(os.path.join(self.root,'wuhbuliding',item["label"]),
