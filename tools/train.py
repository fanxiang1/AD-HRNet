...
from core.criterion import CrossEntropy, OhemCrossEntropy,FocalLoss,FocalLoss2d
...
def main():
    ...
    if config.LOSS.USE_OHEM:
        ...
        # 修改后的损失函数
        # criterion = FocalLoss(ignore_label=config.TRAIN.IGNORE_LABEL,
        #                                  weight=train_dataset.class_weights)

        # 修改后的损失函数
        # criterion = FocalLoss2d(ignore_label=config.TRAIN.IGNORE_LABEL,
        #                                  weight=train_dataset.class_weights)
